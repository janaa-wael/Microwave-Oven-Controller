...
void LCD_SendCommand(char Data_Value)
{
	...
	GPIO_u8SetPinValue (DATA_SPARE_PORT,	LCD_D6_PIN ,  READ_BIT(Data_Value,6)   );
	GPIO_u8SetPinValue (DATA_SPARE_PORT,	LCD_D7_PIN ,  READ_BIT(Data_Value,7)   );
...
void LCD_voidSendData(char character)
{
	...
	GPIO_u8SetPinValue (DATA_SPARE_PORT,	LCD_D6_PIN ,  READ_BIT(character,6)   );
	GPIO_u8SetPinValue (DATA_SPARE_PORT,	LCD_D7_PIN ,  READ_BIT(character,7)   );
	GPIO_u8SetPinValue(CTRL_PORT, LCD_EN_PIN, PIN_HIGH);
	delay(2);
	GPIO_u8SetPinValue(CTRL_PORT, LCD_EN_PIN, PIN_LOW);
}
